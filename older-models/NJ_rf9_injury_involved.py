...
def rf_9(df):
    NJ_for_model = df[[ u'5', '18', u'29', u'40', '41', '26', '30', 'elderly_involved', 'minors_involved', 'involves_injury',\
    'ejection_bool', 'same_direction_crash', 'opposite_direction_crash', 'right_angle_crash', 'overturn', 'backing_up', 'left_or_u_turn', \
    'pedacyclist', 'pedestrian', 'railcar']].apply(pd.to_numeric, errors='coerce')
    ...
    return my_forest
    # gives you a score of 0.773751942495

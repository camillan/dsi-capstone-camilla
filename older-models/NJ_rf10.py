...
def rf_10(df):
    ...
    'ejection_bool', 'same_direction_crash', 'opposite_direction_crash', 'right_angle_crash', 'overturn', 'backing_up', 'left_or_u_turn', \
    'pedacyclist', 'pedestrian', 'railcar', 'bus_or_truck', \
    'suv', 'passenger_or_cargo_van', 'passenger_vehicle', 'motorcycles']].apply(pd.to_numeric, errors='coerce')
    ...
    return my_forest
    # gives you a score of 0.783388419265

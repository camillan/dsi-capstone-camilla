...
def load_process_vehicles_data(filename='/Users/CamillaNawaz/Documents/Capstone_Data/NJ_Vehicles/NJ_vehicles.csv'):
    '''
    Open the whole vehicles data by chunk and concat it all.
    '''
...
if __name__ == '__main__':
    ...
    # Setup accidents table
    NJ = load_NJ()
    NJ = preprocess_NJ_accidents_cols(NJ)

    # Setup occupants table
    ...
    my_list = NJ['0'] # the unique case identifier column
